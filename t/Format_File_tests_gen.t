...
generic%122%La table %s existe sous plusieurs cles etrangères.%La table %s existe sous plusieurs cles etrangères.
...
generic%131%Le tri de séléction '%s' est invalide.%Le tri de séléction '%s' est invalide.
generic%132%Le format de la date '%s' est invalide.%Le format de la date '%s' est invalide.
generic%133%Les eléments % de la date doivent être séparés par un caractère.%Les eléments % de la date doivent être séparés par un caractère.
...
generic%152%L'intance %s est invalide ou non demarrée.%L'intance %s est invalide ou non demarrée.
...
generic%301%Le module applicatif %s n'est pas ou mal declaré.%Le module applicatif %s n'est pas ou mal declaré.
...
generic%314%Le service %s '%s' n'est pas ou mal declaré.%Le service %s '%s' n'est pas ou mal declaré.
generic%315%Le module applicatif %s ne possède aucune instance de service.%Le module applicatif %s ne possède aucune instance de service.
generic%316%La ressource %s '%s' n'est pas ou mal declaré.%La ressource %s '%s' n'est pas ou mal declaré.
...
generic%320%Le type de ressource %s n'est pas ou mal déclaré.%Le type de ressource %s n'est pas ou mal déclaré.
...
generic%420%Impossible d'aller sous le répertoire '%s'.%Impossible d'aller sous le répertoire '%s'.
...
PC_LISTBACK_ARCHORA%0002%Il n'existe pas d'archives commençant a la sequence %s.%Il n'existe pas d'archives commençant a la sequence %s.
